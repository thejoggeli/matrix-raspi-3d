...
/*	if(Input.isKeyDown(81)){
		Haf.camera.rotation -= Time.rawDeltaTime;
...
Input.setup = function(){
	...
	var canvas = Haf.getCanvas(0);
	$(".haf-input").on("touchstart", function(e){
	...
	$(".haf-input").on("touchmove", function(e){
		for(var t = 0; t < e.changedTouches.length; t++){		
			var touch = e.changedTouches[t];
	...
	$(".haf-input").on("touchend", function(e){
		for(var t = 0; t < e.changedTouches.length; t++){
			var touch = e.changedTouches[t];
			var touchWrapper = Input.touches[touch.identifier];
	...
	$(".haf-input").on("mousedown", function(e){
	...
	$(".haf-input").on("mouseup", function(e){
	...
	$(".haf-input").on("mousemove ", function(e){			
